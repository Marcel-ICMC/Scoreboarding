...
public class interfaci extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Source1");

        jLabel3.setText("Source2");
        ...
        jButton2.setText("Proximo Clock");
    ...
    private void initFus(){
        ...
        for (i=0; i<nLoadStore; i++) {
            ...
            insertLinha(jTable3, new Object[]{"Load/Store" + (i), null, "", null,null,null, "","",null,null});
        }
        for (; i<nArithmetic + nLoadStore; i++) {
            fus[i] = new FunctionalUnit("Arithmatic" + (i - nLoadStore));
            insertLinha(jTable3, new Object[]{"Arithmatic" + (i - nLoadStore), null, "", null,null,null, "","", null,null});
        }
    ...
    private void computeScoreboarding(){
        ...
        for (int i=0; i < nLoadStore + nArithmetic; i++) {
                ...
                if(fus[i].getInstruction().getIssue() != -1 && fus[i].getInstruction().getRead_operand() == -1){
                    if (fus[i].isDp() == false) {
                            if (fus[i].isRj() && fus[i].isRk()) {
                                ...
                                jTable3.setValueAt("", i, 6); 
                                jTable3.setValueAt("", i, 7); 
                                jTable3.setValueAt(fus[i].isRj(), i, 8); 
                                jTable3.setValueAt(fus[i].isRk(), i, 9); 
                                continue;
                            }
            ...
            // Write Result
                ...
                if (fus[i].getInstruction().getExecution_complete() != -1 && fus[i].getInstruction().getWrite_result() == -1) {
                    int j=0;
                    if (fus[i].getInstruction().getOperand().equals("SW")){
                        
                        fus[i].setBusy(false);
                        jTable3.setValueAt(fus[i].isBusy(), i, 1); 
                            ...
                            for (int k=0; k<nLoadStore + nArithmetic; k++) {
                                ...
                                if (i != k ) {
                                    if (fus[k].getQj() != null && fus[k].getQj().equals(fus[i].getName())) {
                                        ...
                                        jTable3.setValueAt("", k, 6); 
                                        jTable3.setValueAt(fus[k].isRj(), k, 8); 
                                    }
                                    ...
                                    if (fus[k].getQk() != null && fus[k].getQk().equals(fus[i].getName())) {
                                        ...
                                        jTable3.setValueAt("", k, 7); 
                                        jTable3.setValueAt(fus[k].isRk(), k, 9); 
                                    }
                                    
                                }
                            }

                            fus[i].setFatigue(true);
                            rrs[fus[i].getFi()].setVisited(true);
                            rrs[fus[i].getFi()].setFus(null);
                            jTable4.setValueAt(null, 0, fus[i].getFi()); 
        ...
        if (instruction != null && instruction.getIssue() == -1) {        
            if (rrs[instruction.getRs()].isVisited() == false) {
                if (instruction.getOperand().equals("LW")) {
                        ...
                        if (!fus[i].isFatigue()) {
                            if (!fus[i].isBusy()) {
                                if (rrs[instruction.getRs()].getFus() == null) {
                                    ...
                                    fus[i].setBusy(true);
                                    jTable3.setValueAt(true, i, 1); 
                                    
                                    fus[i].setInstruction(instruction);
                                    jTable3.setValueAt(fus[i].getInstruction().getOperand(), i, 2); 
                                    
                                    fus[i].setFi(instruction.getRs());
                                    jTable3.setValueAt(fus[i].getFi(), i, 3); 
                                    
                                    fus[i].setFj(instruction.getRt());
                                    jTable3.setValueAt(fus[i].getFj(), i, 4); 
                                    
                                    fus[i].setFk(instruction.getImm());
                                    jTable3.setValueAt(fus[i].getFk(), i, 5); 
                                    ...
                                    jTable3.setValueAt(fus[i].getQj(), i, 6); 
                                    jTable3.setValueAt(fus[i].getQk(), i, 7); 
                                    jTable3.setValueAt(fus[i].isRj(), i, 8); 
                                    jTable3.setValueAt(fus[i].isRk(), i, 9); 

                                    rrs[fus[i].getFi()].setFus(fus[i]);
                                    jTable4.setValueAt(fus[i].getName(), 0, fus[i].getFi()); 
                ...
                } else if (instruction.getOperand().equals("SW")) {
                    for (int i=0; i<nLoadStore; i++) {
                        if (!fus[i].isFatigue()) {
                            if (!fus[i].isBusy()) {
                                if (rrs[instruction.getRs()].getFus() == null) {
        ...
        for (int l=0;l < nLoadStore+nArithmetic; l++) {
                fus[l].setFatigue(false);
                /*                if(fus[l].getInstruction() != null && fus[l].getInstruction().getWrite_result() == clock){
                rrs[fus[l].getFi()].setVisited(false);
                System.out.println("setei false");
                }*/
        }
    }
